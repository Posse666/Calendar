...
//        sharedData.add(Contact(mutableListOf("Room Mate"), "roommate@gmail.com", false, false))
        sharedData.add(Contact(mutableListOf("Начальник"), "boss@gmail.com"))
        sharedData.add(Contact(mutableListOf("Мама"), "mother@gmail.com"))
        sharedData.add(Contact(mutableListOf("Батя"), "father@gmail.com"))
        sharedData.add(Contact(mutableListOf("Братюня"), "brother@gmail.com", false, false))
        sharedData.add(Contact(mutableListOf("Дружище"), "bestfriend@gmail.com", false, false))
        sharedData.add(Contact(mutableListOf("Моя подруга"), "girlfriend@gmail.com", false, false))
        sharedData.add(Contact(mutableListOf("Кореш с общаги"), "roommate@gmail.com", false, false))
